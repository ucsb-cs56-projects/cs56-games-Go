 ...
 *
 */
public class AIGameBoard extends JPanel {
    ...
    public AIGameBoard(int x, int y, JTextArea textArea) {
                ...
                if (!surrender) {
                    if (current_player == State.BLACK) {
                        row = Math.round((float) (e.getY() - borderSize)
                                / tileSize);
                        col = Math.round((float) (e.getX() - borderSize)
                                / tileSize);
                        ...
                        row = rand.nextInt(gridSize + 1);
                        col = rand.nextInt(gridSize + 1);
