...
# Developer note
The code is able to run but it is too messy. There are lots of useless interface and full file of code in comment way. This largely increse the difficulty for other developers to understand and coninue write. 
#W16 Final Remarks
